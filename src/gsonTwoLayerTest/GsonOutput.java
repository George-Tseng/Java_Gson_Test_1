...
public class GsonOutput {
	public static void main(String[] args) {
		...
		List<HDD_Info> hddInfoList0 = new ArrayList<>();
		...
		List<HDD_Info> hddInfoList1 = new ArrayList<>();
		...
		List<HDD_Info> hddInfoList2 = new ArrayList<>();
		...
		List<HDD_Info> hddInfoList3 = new ArrayList<>();
		...
		List<HDD> hddList0 = new ArrayList<>();
